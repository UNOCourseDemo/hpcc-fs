...
/**
 * \ingroup network
 * \defgroup queue OldQueue
 */
/**
 * \ingroup queue
 * \brief Abstract base class for packet OldQueues
 * 
 * This class defines the base APIs for packet queues in the ns-3 system
 */
class OldQueue : public Object
{
  public:
   ...
   * \return true if the queue is empty; false otherwise
    ...
    /**
   * Place a packet into the rear of the OldQueue
   * \param p packet to enqueue
   * \return True if the operation was successful; false otherwise
     */
    bool Enqueue (Ptr<Packet> p);
    /**
   * Remove a packet from the front of the OldQueue
   ...
   * Flush the queue.
    ...
    /**
   * \return The number of packets currently stored in the OldQueue
     */
    uint32_t GetNPackets (void) const;
    /**
   * \return The number of bytes currently occupied by the packets in the OldQueue
     */
    uint32_t GetNBytes (void) const;

    /**
   * \return The total number of bytes received by this OldQueue since the
   ...
   * 
    ...
    /**
   * \return The total number of packets received by this OldQueue since the
   * simulation began, or since ResetStatistics was called, according to 
   * whichever happened more recently
     */
    uint32_t GetTotalReceivedPackets (void) const;
    /**
   * \return The total number of bytes dropped by this OldQueue since the
   * simulation began, or since ResetStatistics was called, according to 
   * whichever happened more recently
     */
