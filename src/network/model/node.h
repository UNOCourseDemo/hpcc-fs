...
class Node : public Object
{
  public:
    ...
    uint32_t m_node_type = 0;  // 0 = server (default); SwitchNode sets 1 in its ctor. Must be
                               // initialized: an uninitialized value mistypes servers and crashes
                               // routing setup on large topologies (heap-dependent).
  public:
