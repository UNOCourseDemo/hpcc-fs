...
// ============================================================ 16 · conclusion (dark)
{
  ...
  const rows = [
    ...
    ["RDMA-RCP", "A fabric/slice mode alongside HPCC: 1.005×, flows within 5–13% of oracle (hetero cases), zero PFC, −18–23% coflow JCT. Q16 fixed-point verified; high fan-in needs a longer control interval.", BLUE],
  ];
  rows.forEach((r, i) => {
    const y = 1.55 + i * 1.0;
