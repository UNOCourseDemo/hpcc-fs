...
we delimit the claim explicitly where max-min is not the operator's objective (mixed short-flow
...
right target only when multi-bottleneck flows matter. (ii)~\emph{Fabric scale}: at $k = 6, 8$
