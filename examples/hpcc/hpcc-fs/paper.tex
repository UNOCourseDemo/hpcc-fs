...
such as Bolt or PowerTCP, which would require re-implementing them in this simulator (a
standalone-RCP head-to-head would compare identical control laws, \S\ref{sec:related}); no
