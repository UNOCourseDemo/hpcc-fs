...
\title{Multi-Bottleneck Fairness for High-Precision Congestion Control}
...
\begin{IEEEkeywords}
datacenter networks, congestion control, RDMA, in-network telemetry, max-min fairness
\end{IEEEkeywords}
...
\begin{figure*}[t]
\centering
\subfloat[Tree fabric --- unique shortest paths, no ECMP.\label{fig:topo-tree}]{\includegraphics[width=0.46\textwidth]{fig_topo_tree.png}}\hfill
\subfloat[$k = 4$ ECMP fat-tree (4 pods).\label{fig:topo-ft}]{\includegraphics[width=0.50\textwidth]{fig_topo_fattree.png}}
